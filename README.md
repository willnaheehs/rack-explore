...
- Browse **Hardware catalog** for manufacturer platforms and supplied cluster configurations, including Dell, HPE, Lenovo, Supermicro, NVIDIA, AMD and DDN.
- **Washington B300 cluster:** 32 nodes, 256 B300 GPUs, dual EPYC 9555 per node and a 150 TB shared WEKA service. Explore all nodes and local drives in 3D; inspect WEKA in Storage fabric or Infrastructure. Rack placement is illustrative and missing installation details remain explicit. See [the supplied profile and modeling notes](docs/washington-b300.md).
